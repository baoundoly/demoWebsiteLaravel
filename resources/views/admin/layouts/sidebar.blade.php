        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-compact nav-child-indent" data-widget="treeview" role="menu" data-accordion="true">
                ...
                {{-- <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview">
                            <a href="/admin/post" class="nav-link" style="color:{{ @$nav_menu['color'] }}">
                                <i
                                    class="nav-icon fas fa-car-battery"></i>
                                <p>
                                    Post list
                                </p>
                            </a>
                ...
                {{-- <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview">
                            <a href="/admin/slider" class="nav-link" style="color:{{ @$nav_menu['color'] }}">
                                <i
                                    class="nav-icon fas fa-car-battery"></i>
                                <p>
                                    Slider
                        ...
                        <li class="nav-item has-treeview">
                            <a href="/admin/about" class="nav-link" style="color:{{ @$nav_menu['color'] }}">
                                <i
                                    class="nav-icon fas fa-car-battery"></i>
                                <p>
                                    About
                        ...
                        <li class="nav-item has-treeview">
                            <a href="/admin/product" class="nav-link" style="color:{{ @$nav_menu['color'] }}">
                                <i
                                    class="nav-icon fas fa-car-battery"></i>
                                <p>
                                    Product
