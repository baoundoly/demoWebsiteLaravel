      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header text-right">
            ...
            <a href="{{route('admin.home-management.image-info.list') }}" class="btn btn-sm btn-info"><i class="fas fa-list"></i> Image List</a>
          </div>
          <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{(@$editData)?(route('admin.home-management.image-info.update',$editData)):(route('admin.home-management.image-info.store')) }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
                  <div class="form-group col-md-12">
                      <label class="my-auto justify-content-center"><strong>Image :</strong></label>
