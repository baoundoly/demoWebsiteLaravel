      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header text-right">
            ...
            <a href="{{route('admin.home-management.stock-info.list') }}" class="btn btn-sm btn-info"><i class="fas fa-list"></i> Stock List</a>
          </div>
          <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{(@$editData)?(route('admin.home-management.stock-info.update',$editData)):(route('admin.home-management.stock-info.store')) }}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group d-flex align-items-center">
                    <label class="p-2 flex-shrink-0">Stock List : </label>
...
<script type="text/javascript">
    ...
    var fieldHTML = '<div class="form-group d-flex align-items-center div"><label class="p-2 flex-shrink-0">Stock List : </label><input type="text" name="list[]" class="form-control p-2"/><a class="btn btn-sm btn-danger p-2 flex-shrink-0 remove_button"><i class="fa fa-trash"></i></a></div>'; //New input field html 
