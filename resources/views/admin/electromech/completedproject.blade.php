                ...
                <tr>
                    <td colspan="3">
                        <ul class="pagination justify-content-end">
                            <li class="page-item disabled"><a class="page-link" href="{{ route('page3') }}">Previous</a></li>
                            <li class="page-item active" aria-current="page"><a class="page-link" href="#">1</a></li>
                            <li class="page-item"><a class="page-link" href="{{ route('page2') }}">2</a></li>
                            <li class="page-item"><a class="page-link" href="{{ route('page3') }}">3</a></li>
                            <li class="page-item"><a class="page-link" href="{{ route('page2') }}">Next</a></li>
                          </ul>
                    </td>
                </tr>
            </table>
