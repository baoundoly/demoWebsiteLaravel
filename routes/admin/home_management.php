...
Route::prefix('nav-info')->name('nav-info.')->group(function(){
	...
	Route::get('/edit/{id}', 'NavController@edit')->name('edit');
	Route::post('/update/{id}', 'NavController@update')->name('update');
	Route::get('/get-sub-menu', 'NavController@getSubMenu')->name('get-sub-menu');
